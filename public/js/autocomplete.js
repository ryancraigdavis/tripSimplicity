var today = new Date().toISOString().split('T')[0];
  document.getElementsByName("depart-date")[0].setAttribute('min', today);
  document.getElementsByName("return-date")[0].setAttribute('min', today);
  
var states = ["Aalborg, Denmark|AAL",
"Aalesund, Norway|AES",
